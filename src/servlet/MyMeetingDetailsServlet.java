...
// Source File Name:   MyMeetingDetailsServlet.java
...
public class MyMeetingDetailsServlet extends HttpServlet
{
    ...
    public MyMeetingDetailsServlet()
    {
    }
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            request.getRequestDispatcher("personal_center/mymeetingdetails.jsp").forward(request, response);
        }
        catch(Exception e)
        {
            e.printStackTrace();
