...
// Source File Name:   CancelMeetingServlet.java
...
public class CancelMeetingServlet extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            accountBiz.deleteMeeting(mname, canclereason);
            request.getRequestDispatcher("SelectReserveMeeting").forward(request, response);
        }
        catch(Exception e)
        {
            e.printStackTrace();
